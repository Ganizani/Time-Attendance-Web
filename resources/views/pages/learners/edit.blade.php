                    ...
                    <div class="grid simple ">
                        ...
                        <div class="grid-body ">
                            <form class="form-no-horizontal-spacing" id="edit_form" >
                                <input name="LearnerId" id="LearnerId" type="hidden" class="form-control" value="{{$learner['id']}}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="LearnerFirstName" id="LearnerFirstName" type="text" class="form-control" placeholder="First Name" value="{{$learner['first_name']}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="LearnerLastName" id="LearnerLastName" type="text" class="form-control" placeholder="Last Name" value="{{$learner['last_name']}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="LearnerIdNumber" id="LearnerIdNumber" type="number" class="form-control" placeholder="ID Number" value="{{$learner['id_number']}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="LearnerCardNumber" id="LearnerCardNumber" type="number" class="form-control" placeholder="Card Number" value="{{$learner['card_number']}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="LearnerPhoneNumber" id="LearnerPhoneNumber" type="number" class="form-control" placeholder="Cell Phone, e.g: 074 XXX XXXX" value="{{$learner['phone_number']}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="LearnerEmail" id="LearnerEmail" type="email" class="form-control" placeholder="Email, e.g: user@example.com" value="{{$learner['email']}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="LearnerStipend" id="LearnerStipend" type="number" class="form-control" placeholder="Stipend Amount" value="{{$learner['monthly_stipend']}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row ">
                                            <div class="form-group col-md-6">
                                                <label for="LearnerQualification">Qualification <span class="txt-red"></span></label>
                                                <div class="input-with-icon  right"><i class=""></i>
                                        ...
                                        <div class="row ">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <div class="input-append info col-lg-10 no-padding">
                                                        <input name="LearnerStartDate" id="LearnerStartDate" type="text" class="form-control datepicker" placeholder="Contract Start Date" value="{{$learner['start_date']}}">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <div class="input-append info col-lg-10 no-padding">
                                                        <input name="LearnerEndDate" id="LearnerEndDate" type="text" class="form-control datepicker" placeholder="Contract End Date" value="{{$learner['end_date']}}">
                                                        <span class="add-on"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                                            </div>
...
@section('footer')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#LearnerStatus').select2().select2('val', '{{$learner['status']}}');
            $('#LearnerTitle').select2().select2('val', '{{$learner['title']}}');
            $('#LearnerGender').select2().select2('val', '{{$learner['gender']}}');
            $('#LearnerCompany').select2().select2('val', '{{$learner['company']['id']}}');
            $('#LearnerSite').select2().select2('val', '{{$learner['site']['id']}}');
