            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="grid simple ">
                        ...
                        <div class="grid-body ">
                            <form class="form-no-horizontal-spacing" id="upload_form" action="/api/uploads/devices"  method="post" enctype="multipart/form-data">
                                <div class="row column-seperation">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="DeviceFile">Device File <span class="txt-red">*</span></label>
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="DeviceFile" id="DeviceFile" type="file" class="form-control" accept=".xls, .xlsx">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
