                ...
                <div class="span12">
                    <div class="grid simple ">
                        <div class="grid-title">
                            <h4><b>Apply For Leave Form</b></h4>
                        </div>
                        <div class="grid-body ">
                                        ...
                                        <div class="row ">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="LeaveUser" id="LeaveUser" type="hidden" class="form-control"  value="{{isset($user['id']) ? $user['id'] : ""}}">
                                                    <input name="LeaveUserName" id="LeaveUserName" type="text" class="form-control" placeholder="Employee Applying for Leave" value="{{isset($user['name']) ? $user['name'] : ""}}" disabled>
                                                </div>
                                            </div>
                                        </div>
