                                    ...
                                    <div class="col-md-6">
                                        <div class="row ">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="SiteName" id="SiteName" type="text" class="form-control" placeholder="Name" >
                                                </div>
                                            </div>
                                        ...
                                        <div class="row ">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="SiteEmail" id="SiteEmail" type="email" class="form-control" placeholder="Email, e.g: email@example.com">
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="SitePhoneNumber">Phone Number<span class="txt-red">*</span></label>
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="SitePhoneNumber" id="SitePhoneNumber" type="number" class="form-control" placeholder="Phone Number" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="SiteContactPerson" id="SiteContactPerson" type="text" class="form-control" placeholder="Contact Person">
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="SiteWebsite">Website <span class="txt-red"></span></label>
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="SiteWebsite" id="SiteWebsite" type="number" class="form-control" placeholder="Website" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row ">
                                            <div class="form-group col-md-12">
                                                <label for="SiteAddress">Address <span class="txt-red"></span></label>
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="SiteAddress" id="SiteAddress" type="text" class="form-control" placeholder="Address">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="SiteLatitude" id="SiteLatitude" type="text" class="form-control" placeholder="Latitude">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-with-icon  right"><i class=""></i>
                                                    <input name="SiteLongitude" id="SiteLongitude" type="text" class="form-control" placeholder="Longitude">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
